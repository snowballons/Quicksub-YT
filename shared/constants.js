...
export const MAX_CHANNELS_PER_BATCH = 50; // Maximum channels processed per batch
...
export const SESSION_RESET_DURATION_MS_FREE = 60 * 60000; // 1 minute inactivity resets session (for testing)
export const SESSION_LINK_ALLOWANCE_FREE = 50; // Free tier: 15 channels per session
